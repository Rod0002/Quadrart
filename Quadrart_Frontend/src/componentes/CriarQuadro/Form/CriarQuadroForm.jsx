/** 
 * Import relacionado a React + React Hooks
 */
import React, { useState } from 'react'
import { useNavigate } from 'react-router-dom'

/**
 * Props relacionados a HTML + CSS
 */
...
/**
 * Imports relacionados a formulários
 */
...
/**
 * Import para envio de requests
 */
import axios from "axios"

/**
 * Cropper para cortar imagens
 */
...
const CriarQuadroForm = () => {
    ...
    /* Variáveis necessárias para cropping */
    const [image, setImage] = useState();
    const [cropperOpen, setcropperOpen] = useState(false);


    /* Função para lidar com a cola de imagens via Ctrl+c Ctrl+v */
    ...
    /* Função para lidar a escolha de imagens via clique */
    ...
    /* Requisição a ser executada no envio do formulário */
    const onSubmit = async (values) => {
        ...
        try {
            ...
            values.file = file
            const response = await axios.post("http://localhost:8080/quadro", values, {
                headers: {
                        ...
                        <Box width="100%" display="flex" flexDirection="column" rowGap="5%">
                            <Box>
                                ...
                                <Box display="flex" flexDirection={below760 ? "column" : ""} columnGap="20px">
                                    <Box width="100%" flex={1.2} display="flex" columnGap="2px">
                                        <FormField
                                            wacky={true}
                                            multiline={true}
                                            label={"DURAÇÃO: "}
